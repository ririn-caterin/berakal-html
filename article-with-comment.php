				...
				?>
					<div class="col-lg-4">
						<div class="post">
							...
							<div class="post-box">
								<h2 class="post-title"><a href="#"><?= $judul[$i] ?></a></h2>
								<div class="post-meta">
		...
		<div class="page-inside">
			...
			<div class="comment">
				<div class="comment-btn text-center">
					<button class="btn">Tampilkan Komentar</button>
				</div>

				<!-- daftar komentar - START -->
				<div class="comment-title">2 Komentar</div>
				<ul class="comment-list">
					<li class="comment-item">
						<img class="comment-ava" src="./assets/images/ava-1.jpg" alt="">
						<div class="comment-detail">
							<div class="comment-name">Anika Putri Utami</div>
							<div class="comment-text">Wah keren nih, menarik!</div>
							<div class="comment-info">
								<span class="comment-date">25 September 2020 pukul 04.20 WIB</span>
								<a href="#" class="comment-reply">balas</a>
							</div>
						</div>
					</li>
					<li class="comment-item">
						<img class="comment-ava" src="./assets/images/ava-2.jpg" alt="">
						<div class="comment-detail">
							<div class="comment-name">Ahmad Manarul Hakim <span>(author)</span></div>
							<div class="comment-text">Wah keren nih, menarik!</div>
							<div class="comment-info">
								<span class="comment-date">25 September 2020 pukul 04.20 WIB</span>
								<a href="#" class="comment-reply">balas</a>
