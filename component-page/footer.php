			...
			<div class="row">
				<div class="col-md-3 col-lg-5">
					<div class="footer-info">
						...
						<p>Situs terupdate<br>nomor 1 di Indonesia</p>
					</div>
				</div>
				...
				<div class="col-md-3 col-lg-3">
					...
					<ul class="socmed-links">
						...
						<li><a href="#"><?php include './assets/icons/ic_youtube.svg'; ?></a></li>
						<li><a href="#"><?php include './assets/icons/ic_telegram.svg'; ?></a></li>
					</ul>
				</div>
			</div>
			<div class="text-center footer-copyright">
				&copy; 2020 Berakal.com - All Rights Reserved
			</div>
		</div>
	</footer>
</div>
